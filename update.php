...
<small>W razie czego zosta³eœ uprzedzony :P</small></p>

<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">

<input type="hidden" name="id" id="id" value="<?php echo $id; ?>" />
<input type="submit" name="delete" id="delete" value="Tak, jestem ca³kowicie przekonany o tym ¿e chcê usun¹æ ten kwas." />
